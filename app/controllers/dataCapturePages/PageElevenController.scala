...
class PageElevenController @Inject() (refNumAction: RefNumAction, cc: MessagesControllerComponents)
  extends ForDataCapturePage[IncentivesAndPayments](refNumAction, cc) {
  val format = incf
