...
hint.occupierExplanation=Os ydych yn rhentu neu''n prydlesu''r eiddo, hyd yn oed fel elusen neu sefydliad di-elw, ystyrir mai chi yw''r meddiannydd
...
label.writtenAgreement.leaseAgreementHasBreakClause=A oes cymal torri?
...
details.answer.isBreakClause=Mae cymal torri yn caniatáu i''r landlord neu''r tenant ddod â''r denantiaeth i ben yn gynnar. Bydd manylion y cymal torri i''w gweld yn y brydles neu''r cytundeb ysgrifenedig fel arfer.
...
label.writtenAgreement.steppedDetails.amount=Y rhent y byddwch yn ei dalu, neu wedi''i dalu, yn ystod y cyfnod rhent grisiog hwn, ac eithrio TAW
...
hint.totalRent.annualRentExcludingVat=Nodwch y cyfanswm blynyddol (ac eithrio TAW) hyd yn oed os ydych yn talu bob mis neu bob chwarter. Anwybyddwch unrhyw gyfnod di-rent.
...
label.partRent=Ai dim ond ar gyfer rhan o''r eiddo hwn mae''r rhent yn cael ei dalu?
...
label.livingAccomodation=A yw''r rhent hwn yn cynnwys unrhyw lety preswyl?
...
hint.landOnly=Er enghraifft, nid oes adeiladau ar y safle, neu gwnaethoch godi eich adeilad eich hun
...
hint.label.parking.rentIncludeParking=Os oes gennych nifer amhenodol o fannau mewn maes parcio cymunol, nodwch frasamcan o nifer y mannau sydd ar gael i chi.
