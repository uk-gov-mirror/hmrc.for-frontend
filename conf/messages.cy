...
hint.propertyIsSublet=Gall hyn gynnwys fflatiau, hysbysfyrddau, garejys a llefydd parcio ceir
...
label.LandlordConnectionTypes=Beth yw''r cysylltiad rhyngoch chi a''r landlord?
label.LandlordConnectionTypes.agent=Beth yw''r cysylltiad rhwng eich cleient a''r landlord?
...
label.noJs.setepedrent=Dylech ond ateb hyn os ydych wedi dewis ‘Ie’
details.question.stepedRent=Beth yw rhent gris?
details.answer.stepedRent=Mae rhent gris yn rhoi gwybod i chi/eich cleient ymlaen llaw sut y bydd y rhent yn newid dros y blynyddoedd hyd at yr adolygiad rhent nesaf neu ddyddiad adnewyddu''r brydles.
details.question.isBreakClause=Beth yw cymal torri?
details.answer.isBreakClause=Mae cymal torri yn caniatáu i chi/eich cleient a/neu''r landlord ddod â''r denantiaeth i ben yn gynnar. Byddwch fel arfer yn dod o hyd i fanylion y cymal torri yn y brydles neu''r cytundeb ysgrifenedig.
...
hint.shellUnit=Er enghraifft, eiddo newydd ond heb ei orffen y mae angen gosod ffitiadau ynddo
...
label.parking.rentSeparateParking=A ydych yn talu mwy am le parcio neu garejys?
label.parking.rentSeparateParking.agent=A yw eich cleient yn talu mwy am le parcio neu garejys?
...
label.parking.annualSeparateParking=Telir swm blynyddol sefydlog am lefydd parcio a garejys yn ychwanegol at y rhent heb gynnwys TAW
...
label.includedServices=A yw costau gwasanaethau wedi''u cynnwys yn y rhent?
...
hint.propertyAlterations=Rhowch wybod i ni am unrhyw waith adeiladu neu welliannau a wnaed (e.e. gosod ffitiadau cychwynnol, atgyweiriadau neu waith adnewyddu). Ticiwch ‘Naddo’ os dechreuodd y brydles dros 15 mlynedd yn ôl.
...
hint.propertyAlterationsDetails=Er mwyn cynnwys mwy o waith, defnyddiwch ‘Ychwanegu mwy’
...
userType.occupier=Y Deiliad
userType.occupiersAgent=Asiant y Deiliad 
userType.owner=Y Perchennog
